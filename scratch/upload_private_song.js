...
const tempFile = 'scratch/song_to_upload.json';
fs.writeFileSync(tempFile, JSON.stringify(songData));

try {
    const cmd = `powershell -ExecutionPolicy Bypass -Command "npx firebase database:set /users/${uid}/songs/${songId} ${tempFile} --project ${projectId}"`;
    console.log(`Running: ${cmd}`);
    execSync(cmd, { stdio: 'inherit' });
    console.log('Successfully uploaded song to Firestore');
} catch (e) {
