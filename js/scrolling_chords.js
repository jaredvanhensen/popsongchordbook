// Scrolling Chords Logic (v2.1008)
...
let audioEnabled = true; // Initial default, will be overridden by Profile setting (v2.1008)
...
window.addEventListener('message', (event) => {
    ...
    if (msg.type === 'loadChordData') {
        ...
        if (msg.uid) {
            currentUid = msg.uid;
            // Apply default audio setting from Profile (v2.1008)
