...
let audioEnabled = true; // Initial default, will be overridden by Profile setting (v2.963)
...
window.addEventListener('message', (event) => {
    ...
    if (msg.type === 'loadChordData') {
        ...
        if (msg.uid) {
            currentUid = msg.uid;
            // Apply default audio setting from Profile (v2.963)
