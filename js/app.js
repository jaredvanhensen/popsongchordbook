...
class App {
    ...
    async init() {
        ...
        console.log("Pop Song Chord Book - App Initialized (v2.286)");
    ...
    setupExtractorListener() {
        console.log('UG Extractor listener initialized (v2.286)');
