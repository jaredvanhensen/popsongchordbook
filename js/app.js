...
class App {
    ...
    async init() {
        ...
        console.log("Pop Song Chord Book - App Initialized (v2.362)");
    ...
    setupExtractorListener() {
        console.log('UG Extractor listener initialized (v2.362)');
