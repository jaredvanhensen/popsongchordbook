...
class App {
    ...
    async init() {
        ...
        console.log("Pop Song Chord Book - App Initialized (v2.311)");
    ...
    setupExtractorListener() {
        console.log('UG Extractor listener initialized (v2.311)');
